...
COScopeCtrl::COScopeCtrl()
{
  ...
  m_dPreviousPosition2 =   0.0 ;
  m_dPreviousPosition3 =   0.0 ;
  ...
  m_crPlotColor  = RGB(255, 0, 0) ;  // see also SetPlotColor
  m_crPlotColor2  = RGB(0, 255, 0) ;  // see also SetPlotColor
  m_crPlotColor3  = RGB(0, 0, 255) ;  // see also SetPlotColor

  // protected variables
  m_penPlot.CreatePen(PS_SOLID, 0, m_crPlotColor) ;
  m_penPlot2.CreatePen(PS_SOLID, 0, m_crPlotColor2) ;
  m_penPlot3.CreatePen(PS_SOLID, 0, m_crPlotColor3) ;
...
/////////////////////////////////////////////////////////////////////////////
void COScopeCtrl::SetPlotColor(COLORREF color,COLORREF color2,COLORREF color3)
{
  m_crPlotColor = color ;
  m_crPlotColor2 = color2 ;
  m_crPlotColor3 = color3 ;


  m_penPlot.DeleteObject() ;
  m_penPlot.CreatePen(PS_SOLID, 0, m_crPlotColor) ;

  m_penPlot2.DeleteObject() ;
  m_penPlot2.CreatePen(PS_SOLID, 0, m_crPlotColor2) ;

  m_penPlot3.DeleteObject() ;
  m_penPlot3.CreatePen(PS_SOLID, 0, m_crPlotColor3) ;
...
/////////////////////////////////////////////////////////////////////////////
void COScopeCtrl::AppendPoint(double dNewPoint,double dNewPoint2,double dNewPoint3)
{
  ...
  m_dCurrentPosition2 = dNewPoint2 ;
  m_dCurrentPosition3 = dNewPoint3 ;
  DrawPoint() ;
...
void COScopeCtrl::DrawPoint()
{
  ...
  int currX2, prevX2, currY2, prevY2 ;
  int currX3, prevX3, currY3, prevY3 ;

  CPen *oldPen,*oldPen2,*oldPen3 ;
  CRect rectCleanUp ;
  ...
  if (m_dcPlot.GetSafeHdc() != NULL)
  {
	...
	{
		// grab the plotting pen
		oldPen2 = m_dcPlot.SelectObject(&m_penPlot2) ;

		// move to the previous point
		prevX2 = m_rectPlot.right-m_nPlotShiftPixels ;
		prevY2 = m_rectPlot.bottom - 
				(long)((m_dPreviousPosition2 - m_dLowerLimit) * m_dVerticalFactor) ;
		m_dcPlot.MoveTo (prevX2, prevY2) ;

		// draw to the current point
		currX2 = m_rectPlot.right-m_nHalfShiftPixels ;
		currY2 = m_rectPlot.bottom -
				(long)((m_dCurrentPosition2 - m_dLowerLimit) * m_dVerticalFactor) ;
		m_dcPlot.LineTo (currX2, currY2) ;
	}

		{
		// grab the plotting pen
		oldPen3 = m_dcPlot.SelectObject(&m_penPlot3) ;

		// move to the previous point
		prevX3 = m_rectPlot.right-m_nPlotShiftPixels ;
		prevY3 = m_rectPlot.bottom - 
				(long)((m_dPreviousPosition3 - m_dLowerLimit) * m_dVerticalFactor) ;
		m_dcPlot.MoveTo (prevX3, prevY3) ;

		// draw to the current point
		currX3 = m_rectPlot.right-m_nHalfShiftPixels ;
		currY3 = m_rectPlot.bottom -
				(long)((m_dCurrentPosition3 - m_dLowerLimit) * m_dVerticalFactor) ;
		m_dcPlot.LineTo (currX3, currY3) ;
	}
	...
	m_dPreviousPosition2 = m_dCurrentPosition2 ;
	m_dPreviousPosition3 = m_dCurrentPosition3 ;

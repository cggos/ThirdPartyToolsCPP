...
//
//=============================================================================
BOOL CGdipButton::LoadStdImage(UINT id, LPCTSTR pType, HMODULE hInst /*= NULL*/, int nSize /*= 16*/)
{
	if (m_pStdImage)
		m_pStdImage->Empty();
	m_pStdImage = NULL;
	...
	return m_pStdImage->Load(id, pType, hInst, nSize);
}

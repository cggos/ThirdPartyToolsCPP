...
public:
	...
	BOOL LoadStdImage(UINT id, LPCTSTR pType, HMODULE hInst = NULL, int nSize = 16);
	//BOOL LoadStdIcon(UINT id, int nSize, LPCTSTR pType, HINSTANCE hInst = NULL, int nSize = 16);
